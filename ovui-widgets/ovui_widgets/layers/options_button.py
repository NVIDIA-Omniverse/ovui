...
of checkbox items, one per :class:`~ovui_widgets.layers.layer_settings.LayerSettings`
...
backing :class:`ovui_widgets.common.settings.Settings` store, which
...
not recognise SVG; ``ovui_widgets.app/resources/icons/settings.svg`` is therefore
...
if TYPE_CHECKING:  # pragma: no cover — import guard
    from ovui_widgets.layers.layer_model import DefaultLayerSettings
