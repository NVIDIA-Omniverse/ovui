...
:class:`~ovui_widgets.common.adapters.LayerStackAdapter`; it never reaches into
...
:class:`ovui_widgets.stage.widget.hierarchy_model.HierarchyItem`: the seven
...
class LayerItem(ui.AbstractItem):
    ...
    def invalidate_flags(self) -> None:
        ...
        :class:`~ovui_widgets.common.adapters.LayerEvent` that touches a flag on
