...
- :meth:`set_value` pushes a :class:`SetLayerLockCommand` through the
  owning :class:`~ovui_widgets.app.application.Application`'s
  :class:`~ovui_widgets.common.undo.UndoManager` so the lock toggle joins the undo
...
contract as :class:`~ovui_widgets.layers.models.mute_model.LocalMuteValueModel`.
Unlike :class:`~ovui_widgets.layers.models.save_model.SaveValueModel` (whose
...
from ovui_widgets.layers.commands import SetLayerLockCommand
