...
:class:`~ovui_widgets.layers.layer_delegate.LayerDelegate` consults when it paints
the row background: which :class:`~ovui_widgets.layers.layer_item.LayerItem` the
...
:class:`ovui_widgets.stage.drop_visual_controller.DropVisualController`). The
...
class DropVisualController:
    ...
    def show_rejected(
        ...
        and by the model as the :class:`~ovui_widgets.common.error_reporter.ErrorReporter`
