...
``ovui_widgets.app.application``; moving it here lets widget code import the
return type without depending on ``ovui_widgets.app``.
"""
...
class CallbackHandle:
    ...
    Moved from ``ovui_widgets.app.application``. Behavior is identical to the
