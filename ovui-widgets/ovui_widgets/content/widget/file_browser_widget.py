...
Mirrors :class:`ovui_widgets.stage.widget.StageWidget` in both lifecycle (no
...
from ovui_widgets.content.widget.browser_bar import BrowserBar
...
# stage". Mirrors :attr:`ovui_widgets.app.application.Application._USD_EXTENSIONS`
...
def _to_open_path(url: str) -> str:
    ...
    :func:`ovui_widgets.content.widget.file_card._file_url_to_path`.
    """
...
# Step 38 — GLFW modifier bit for Ctrl. Matches :mod:`ovui_widgets.app.application`
...
class FileBrowserWidget:
    ...
    (Step 10 → :class:`ovui_widgets.content.window.ContentBrowserWindow`).
    """
    ...
    def _build_empty_state_overlay(self) -> None:
        ...
        Layout mirrors ``ovui_widgets.stage.StageWidget._empty_state_container``
    ...
    def _schedule_parent_fallback(self) -> None:
        ...
        one frame via :meth:`ovui_widgets.app.application.Application.call_later`
    ...
    def go_back(self) -> None:
        ...
        :class:`ovui_widgets.app.application.Application`. Delegates to
    ...
    def _on_search_changed(self, text: str) -> None:
        ...
        typing (debounced via :meth:`ovui_widgets.app.application.Application.call_later`)
