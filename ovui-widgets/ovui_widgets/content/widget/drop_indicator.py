...
visual feedback). Mirrors the :class:`ovui_widgets.stage.widget.DropVisualController`
...
# drop-hover. Paired with :data:`ovui_widgets.content.style.CONTENT_STYLES`
...
class DropIndicator:
    ...
    * :meth:`show_between_line` — records a y-coordinate for a
    ...
    def show_row_highlight(self, row_widget: Any) -> None:
        ...
        token :mod:`ovui_widgets.app.style` registers for the Stage Browser's
