...
# ``Content.Card.Label`` (see :mod:`ovui_widgets.content.style`).
...
# :mod:`ovui_widgets.content.widget.browser_bar` and
# :mod:`ovui_widgets.content.widget.file_browser_delegate`: the ovui
...
class FileCard:
    ...
    * ``on_double_click()`` — fired on a double-click (left button
    ...
    def _build_image_area(self) -> None:
        ...
        ``Content.Card.Image::cut`` (see :mod:`ovui_widgets.content.style`)
