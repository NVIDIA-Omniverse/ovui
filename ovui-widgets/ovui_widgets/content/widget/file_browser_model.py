...
class _DropState:
    ...
    :class:`ovui_widgets.content.widget.context_menu._PasteState` so
...
class FileBrowserModel(ui.AbstractItemModel):
    ...
    one frame via :meth:`ovui_widgets.app.application.Application.call_later` so a
    ...
    def __init__(
        ...
        # returns a no-op :class:`ovui_widgets.common.settings.Subscription`, so a
    ...
    def resolve(self, url: str) -> Optional[FileItem]:
        ...
        Mirrors
        :meth:`ovui_widgets.stage.widget.hierarchy_model.HierarchyModel.resolve_path`:
    ...
    def _schedule_item_changed(self, item: Optional[FileItem]) -> None:
        ...
        If the :class:`ovui_widgets.app.application.Application` singleton is not
    ...
    def _schedule_thumbnail_populate(self, parent: FileItem) -> None:
        ...
        :meth:`ovui_widgets.app.application.Application.call_later` splits the two
        ...
        that do not spin up an :class:`ovui_widgets.app.application.Application`
    ...
    def _populate_thumbnails(self, parent: FileItem) -> None:
        ...
        * :meth:`_schedule_item_changed` fires once after the loop so a
        ...
        :class:`ovui_widgets.app.testing.MockBackend` and
        :class:`ovui_widgets.content.backends.local_fs.LocalFSBackend` agree); the
