...
via :meth:`ovui_widgets.app.application.Application.call_later` — typing "dem"
...
# :mod:`ovui_widgets.stage.widget.stage_widget` so the two fields read as a
...
class SearchField:
    ...
    * ``on_search(text: str)`` — fired 200 ms after the user stops
    ...
    :meth:`ovui_widgets.app.application.Application.call_later(0.0, ...)`
    ...
    def build(self) -> None:
        ...
        :mod:`ovui_widgets.stage.widget.stage_widget` so the two search surfaces
    ...
    def _schedule_debounced_fire(self) -> None:
        ...
        When the :class:`ovui_widgets.app.application.Application` singleton is
