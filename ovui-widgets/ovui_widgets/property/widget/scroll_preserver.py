...
Selection changes rebuild :class:`~ovui_widgets.property.window.PropertyWindow`'s
...
:meth:`~ovui_widgets.property.payload.PropertyPayload.get_scheme` matches the prior
...
class ScrollPreserver:
    ...
    :param call_later: Callable matching
        :meth:`ovui_widgets.app.application.Application.call_later` — takes
    ...
    def restore_position(self, new_scheme: str) -> None:
        ...
        :param new_scheme: Scheme string from the new payload
            (:meth:`~ovui_widgets.property.payload.PropertyPayload.get_scheme`).
        """
