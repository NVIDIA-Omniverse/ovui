...
from ovui_widgets.common.testing.mock_property import MockPropertyAdapter as MockPropertyAdapterDirect
...
class TestSubscribeChanges:
    def test_subscribe_returns_subscription(self):
        from ovui_widgets.common.testing.mock_property import _MockPropertySubscription
        adapter = MockPropertyAdapter()
