...
is already owned by the :mod:`ovui_widgets.property` Property Panel variant
...
from ovui_widgets.content.widget import HighlightLabel
from ovui_widgets.content.widget.highlight_label import (
...
class TestSurface:
    def test_highlight_label_reexported_from_widget_package(self):
        from ovui_widgets.content.widget import HighlightLabel as HL
    ...
    def test_palette_has_highlight_highlight_token(self):
        ...
        import ovui_widgets.app.style  # noqa: F401 — register palette shades
...
class TestModelTextFilterProperty:
    def test_default_is_empty_string(self):
        ...
        from ovui_widgets.content.widget import FileBrowserModel
