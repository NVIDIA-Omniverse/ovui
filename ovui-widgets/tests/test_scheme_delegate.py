...
class TestImportShape:
    def test_importable_from_widget_subpackage(self):
        from ovui_widgets.property.widget import PropertySchemeDelegate as D
        assert D is not None

    def test_importable_from_direct_module(self):
        from ovui_widgets.property.widget.scheme_delegate import PropertySchemeDelegate as D
        assert D is not None

    def test_re_export_identity(self):
        from ovui_widgets.property.widget import PropertySchemeDelegate as A
        from ovui_widgets.property.widget.scheme_delegate import (
