...
class _FakeApp:
    """Stand-in for :class:`ovui_widgets.app.application.Application` with a ``call_later``."""
...
class TestSimplePropertyWidgetImportShape:
    ...
    def test_re_export_identity(self):
        from ovui_widgets.property.widget import SimplePropertyWidget as A
        from ovui_widgets.property.widget.simple_property_widget import SimplePropertyWidget as B
        assert A is B
    ...
    def test_is_property_widget_subclass(self):
        from ovui_widgets.property.widget import PropertyWidget, SimplePropertyWidget
...
class TestBuildItemsCreatesFrame:
    ...
    def test_collapsable_frame_uses_compact_property_header_builder(self, fake_ui):
        frame_cls, _ = fake_ui
        from ovui_widgets.property.group_widget import build_property_group_header
        from ovui_widgets.property.widget import SimplePropertyWidget
        w = SimplePropertyWidget(title="Transform")
        w.build_items()
    ...
    def test_collapsable_frame_uses_fit_content_height(self, fake_ui):
        frame_cls, _ = fake_ui
        from ovui_widgets.property.group_widget import FIT_CONTENT_HEIGHT
        from ovui_widgets.property.widget import SimplePropertyWidget
        w = SimplePropertyWidget(title="Transform")
        w.build_items()
    ...
    def test_content_stack_has_no_internal_vertical_gap(self, fake_ui):
        _, vstack_cls = fake_ui
        from ovui_widgets.property.group_widget import GROUP_CONTENT_SPACING
        from ovui_widgets.property.widget import SimplePropertyWidget
        w = SimplePropertyWidget(title="Transform")
        w.build_items()
...
class TestAttributesWidgetRebase:
    def test_attributes_widget_is_simple_property_widget_subclass(self):
        ...
        from ovui_widgets.property.widget import AttributesWidget, SimplePropertyWidget
