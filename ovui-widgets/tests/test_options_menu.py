...
from ovui_widgets.content.widget import OptionsButton
from ovui_widgets.content.widget.file_browser_model import (
    FileBrowserSortPolicy,
)
from ovui_widgets.content.widget.options_menu import (
    _SORT_LABELS,
)
from ovui_widgets.content.widget.options_menu import (
...
class TestSurface:
    def test_options_button_reexported_from_widget_package(self):
        from ovui_widgets.content.widget import OptionsButton as OB
