...
"""Tests for :class:`ovui_widgets.content.widget.file_browser_model.FileBrowserModel`.
...
class TestGlobFilter:
    ...
    def test_glob_filter_case_insensitive(self, backend: MockBackend):
        ...
        from ovui_widgets.app.testing.mock_backend import _MockEntry
...
class TestSortPolicy:
    def test_sort_policy_name_asc_puts_folders_first_then_natural_sort(
        ...
        from ovui_widgets.app.testing.mock_backend import _MockEntry  # type: ignore
