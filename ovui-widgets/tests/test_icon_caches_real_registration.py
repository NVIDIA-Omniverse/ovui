...
EXPECTED_REGISTRATIONS = (
    # 15 dict caches.
    ("ovui_widgets.content.widget.file_card", "dict", "_PROVIDER_CACHE"),
    ("ovui_widgets.content.widget.filter_button", "dict", "_PROVIDER_CACHE"),
    ("ovui_widgets.content.widget.browser_bar", "dict", "_PROVIDER_CACHE"),
    ("ovui_widgets.content.widget.navigation_model", "dict", "_PROVIDER_CACHE"),
    ("ovui_widgets.content.widget.zoom_bar", "dict", "_PROVIDER_CACHE"),
    ("ovui_widgets.content.widget.bookmark_button", "dict", "_PROVIDER_CACHE"),
    ("ovui_widgets.content.widget.file_browser_delegate", "dict", "_PROVIDER_CACHE"),
    ("ovui_widgets.content.widget.search_field", "dict", "_PROVIDER_CACHE"),
    ("ovui_widgets.content.widget.options_menu", "dict", "_PROVIDER_CACHE"),
    ("ovui_widgets.common.icon_caches", "dict", "_PROVIDER_CACHE"),
    ("ovui_widgets.layers.layer_icons", "dict", "_PROVIDER_CACHE"),
    ("ovui_widgets.layers.layer_delegate", "dict", "_CHEVRON_PROVIDER_CACHE"),
    ("ovui_widgets.viewport.viewport_widget", "dict", "_TOOLBAR_ICON_PROVIDERS"),
    ("ovui_widgets.property.window", "dict", "_FILTER_ICON_CACHE"),
    ("ovui_widgets.layers.window", "dict", "_LAYERS_FILTER_ICON_CACHE"),
    # 1 module-scope singleton (lazy-init module global).
    ("ovui_widgets.app.menu_bar", "singleton", "_LOGO_PROVIDER"),
    # 2 helper-class singletons via stable-string-keyed classmethod.
    (
        "ovui_widgets.content.file_importer",
        "classmethod",
        "FileImporterHelper.reset_singleton",
    ),
    (
        "ovui_widgets.content.file_exporter",
        "classmethod",
    ...
    (
        "ovui_widgets.common.dialogs",
        "module_callable",
        "_clear_open_dialogs",
    ),
    (
        "ovui_widgets.common.file_dialogs",
        "module_callable",
        "_clear_open_dialogs",
    ),
    (
        "ovui_widgets.content.widget.confirm_overwrite_dialog",
        "module_callable",
        "_clear_open_dialogs",
    ),
)
...
from ovui_widgets.common import icon_caches  # noqa: E402 — imports follow the side-effect block
