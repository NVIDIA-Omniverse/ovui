...
"""Tests for :class:`ovui_widgets.app.testing.MockBackend`.
...
from ovui_widgets.app.testing.mock_backend import (
    _BASE_TIME,
    _build_default_tree,
    _MockEntry,
    _parts_to_url,
...
class TestImport:
    def test_mock_backend_exported_from_testing(self):
        from ovui_widgets.app.testing import MockBackend as MB
        assert MB is MockBackend

    def test_package_all_contains_mock_backend(self):
        import ovui_widgets.app.testing as pkg
