...
"""Tests for ovui_widgets.app.style: URL constants, GLOBAL_STYLES dict, and style helpers.
...
class TestURLConstants:
    def test_urls_module_importable(self):
        from ovui_widgets.common.style import urls  # noqa: F401
    ...
    def test_url_name_registered(self, name):
        ...
        import ovui_widgets.app.style  # noqa: F401 — ensures urls.py has run
    ...
    def test_icon_file_exists(self, icon_name, file_name):
        ...
        from ovui_widgets.common.style import urls as _urls_module
...
class TestStyleHelpers:
    def test_apply_global_styles_callable(self):
        import ovui_widgets.app.style
        assert callable(ovui_widgets.app.style.apply_global_styles)

    def test_set_theme_callable(self):
        import ovui_widgets.app.style
        assert callable(ovui_widgets.app.style.set_theme)
    ...
    def test_apply_global_styles_sets_default(self):
        ...
        import ovui_widgets.app.style
        ovui_widgets.app.style.apply_global_styles()
    ...
    def test_set_theme_light_does_not_crash(self):
        import ovui_widgets.app.style
        ovui_widgets.app.style.set_theme("light")

    def test_set_theme_dark_does_not_crash(self):
        import ovui_widgets.app.style
        ovui_widgets.app.style.set_theme("dark")

    def test_set_theme_unknown_falls_back_to_dark(self):
        import ovui_widgets.app.style
        ovui_widgets.app.style.set_theme("unknown")  # should not raise
...
class TestRegisterUrls:
    ...
    def test_register_urls_does_not_crash(self):
        from ovui_widgets.common.style.urls import register_urls
    ...
    def test_style_icons_dir_exists(self):
        from ovui_widgets.common.style.urls import _STYLE_ICONS_DIR
        assert _STYLE_ICONS_DIR.is_dir()

    def test_style_icon_paths_are_in_style_icons_dir(self):
        from ovui_widgets.common.style.urls import _STYLE_ICON_PATHS, _STYLE_ICONS_DIR
    ...
    def test_register_urls_idempotent_no_crash(self):
        from ovui_widgets.common.style.urls import _STYLE_ICON_PATHS, register_urls
        register_urls()
...
class TestControlStateIcons:
    """Step 4.4 — per-state SVG glyphs in ``ovui_widgets.app/style/icons/``.
...
class TestGetIconPath:
    ...
    def test_agrees_with_style_icon_paths_dict(self):
        ...
        from ovui_widgets.common.style.urls import _STYLE_ICON_PATHS, get_icon_path
        for name, path in _STYLE_ICON_PATHS.items():
...
class TestControlStateHandlerIconWiring:
    ...
    ``ovui_widgets.app/resources/icons/``. Step 4.4 retargets them at the
    dedicated glyphs under ``ovui_widgets.app/style/icons/`` — this test pins
    that the retarget actually happened and stays valid after future
    handler-registration refactors.
    """

    def _fresh_handlers(self):
        from ovui_widgets.property.parts import ControlStateManager
...
class TestLayersStyles:
    ...
    def test_layers_palette_token_registered(self, name):
        ...
        import ovui_widgets.app.style  # noqa: F401 — triggers palette registration
        val = getattr(cl, name)
        assert isinstance(val, str)
        assert val == name
...
class TestSvgRenderingFlag:
    ...
    def test_flag_matches_in_kit_constant(self):
        ...
        from ovui_widgets.property.parts.control_state import _SVG_RENDERING_AVAILABLE
