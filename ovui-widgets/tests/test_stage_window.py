...
class TestImportsAndStructure:
    def test_import_from_window_subpackage(self):
        from ovui_widgets.stage.window import StageWindow as SW
        assert SW is StageWindow

    def test_exported_from_ovui_widgets_stage(self):
        import ovui_widgets.stage
        assert ovui_widgets.stage.StageWindow is StageWindow
...
class TestWindowLifecycle:
    def test_title_preserves_dock_key(self):
        # ovui_widgets.app/layout.py's imgui.ini keys on "Stage Browser" — changing the
