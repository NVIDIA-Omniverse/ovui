...
:class:`~ovui_widgets.layers.layer_model.LayerModel`:
...
- :meth:`drop` — executes a validated move by pushing a
  :class:`~ovui_widgets.layers.commands.MoveSublayerCommand` through the app's
...
from ovui_widgets.layers.commands import MoveSublayerCommand
