...
"""Tests for :class:`ovui_widgets.content.widget.file_item.FileItem`.
...
from ovui_widgets.common.asset_types import AssetCategory, get_category
from ovui_widgets.content.backends.backend_adapter import (
    BackendFileFlags,
    BackendListEntry,
    BackendResult,
)
from ovui_widgets.content.widget import FileItem as FileItemReexport
from ovui_widgets.content.widget.file_item import (
    FileItem,
    _format_date,
    _format_size,
    _NoLock,
...
class TestIconKey:
    ...
    def test_category_matches_get_category(self, usd_leaf: FileItem):
        ...
        # dispatcher in :mod:`ovui_widgets.common.asset_types`. They disagree only
