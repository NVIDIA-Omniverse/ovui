...
from ovui_widgets.content.widget.collections.disk_partitions import (
    FSTYPE_BLOCKLIST,
    Partition,
    _parse_mounts_line,
    disk_partitions,
...
def patched_mounts(monkeypatch, tmp_path):
    ...
    """
    from ovui_widgets.content.widget.collections import disk_partitions as dp_mod

    monkeypatch.setattr(dp_mod, "os", SimpleNamespace(name="posix"))
