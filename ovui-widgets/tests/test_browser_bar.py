...
from ovui_widgets.content.widget import BrowserBar, VisitedHistory
...
class TestSurface:
    def test_browser_bar_reexported_from_widget_package(self):
        from ovui_widgets.content.widget import BrowserBar as BB

        assert BB is _BrowserBar

    def test_visited_history_reexported_from_widget_package(self):
        from ovui_widgets.content.widget import VisitedHistory as VH
