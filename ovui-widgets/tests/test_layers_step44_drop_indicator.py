...
Step 44 adds a :class:`~ovui_widgets.layers.drop_visual_controller.DropVisualController`
owned by :class:`~ovui_widgets.layers.layer_model.LayerModel` that tracks the
...
for invalid drops. The :class:`~ovui_widgets.layers.layer_delegate.LayerDelegate`
