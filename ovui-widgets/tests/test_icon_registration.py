...
* Every ``asset_*`` URL key announced by ``ovui_widgets.common.asset_types`` is
  registered by ``ovui_widgets.common.style.urls.register_urls`` and resolves to an
...
import ovui_widgets.app.style  # noqa: F401 — ensures register_urls() has run.
from ovui_widgets.common.asset_types import _CATALOG, AssetCategory, categories
from ovui_widgets.common.style import urls as _urls_module
from ovui_widgets.common.style.urls import _STYLE_ICON_PATHS, get_icon_path, register_urls
