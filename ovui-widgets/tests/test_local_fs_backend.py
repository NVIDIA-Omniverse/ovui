...
"""Tests for :class:`ovui_widgets.content.backends.LocalFSBackend`.
...
from ovui_widgets.content.backends.local_fs_backend import _fspath_to_url, _url_to_fspath
...
class TestImport:
    def test_localfs_exported(self):
        from ovui_widgets.content.backends import LocalFSBackend as LFB
    ...
    def test_ovui_widgets_exports_are_services_objects(self):
        from ovui_data_adapters.services.content.backends import (
            LocalFSBackend as ServicesLocalFSBackend,
        )
        from ovui_data_adapters.services.content.backends.local_fs_backend import (
            _fspath_to_url as services_fspath_to_url,
            _url_to_fspath as services_url_to_fspath,
        )

        assert LocalFSBackend is ServicesLocalFSBackend
        assert _fspath_to_url is services_fspath_to_url
        assert _url_to_fspath is services_url_to_fspath
