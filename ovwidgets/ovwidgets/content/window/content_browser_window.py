...
backend swap. Mirrors :class:`ovwidgets.stage.window.StageWindow` so the
...
class ContentBrowserWindow(ManagedWindow):
    ...
    def _resolve_bookmarks() -> Optional[BookmarksManager]:
        ...
        :meth:`ovwidgets.common.settings.Settings.instance` so the read
    ...
    def _resolve_recent_files(
        ...
        _recent_files}`` to
        :meth:`ovwidgets.common.recent_files.RecentFileList.instance`
        and :meth:`ovwidgets.common.settings.Settings.instance` so the
    ...
    def go_back(self) -> None:
        ...
        :meth:`ovwidgets.app.application.Application._on_key_pressed`). No-op
    ...
    def forward_modifier_bits(self, bits: int) -> None:
        ...
        Called by :meth:`ovwidgets.app.application.Application._on_key_pressed`
    ...
    def _on_key_pressed(
        ...
        Wired from :meth:`ovwidgets.app.application.Application._on_key_pressed`
