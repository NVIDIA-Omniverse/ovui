...
# :mod:`ovwidgets.common.icon_caches`) tears down everything left in the list at
...
# Same pattern as ovwidgets.app/dialogs.py and ovwidgets.app/file_dialogs.py. The
