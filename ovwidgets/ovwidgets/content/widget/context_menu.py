...
Stubs route through :class:`ovwidgets.common.error_reporter.ErrorReporter` so the
...
from ovwidgets.content.widget import clipboard, file_ops
...
class FileContextMenu:
    ...
    def __init__(self, widget: "FileBrowserWidget") -> None:
        ...
        # :class:`ovwidgets.property.parts.attr_context_menu`). Replaced on
