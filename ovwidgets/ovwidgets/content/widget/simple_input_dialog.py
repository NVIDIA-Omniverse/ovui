...
status via :class:`ovwidgets.common.error_reporter.ErrorReporter`. The dialog
...
:class:`~ovwidgets.content.widget.path_field.PathField` popup
...
class SimpleInputDialog:
    ...
    def _build_content(self) -> None:
        ...
        :mod:`ovwidgets.app.style.styles` and carry the accent / neutral colour
