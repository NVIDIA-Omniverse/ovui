...
checkable :class:`ui.MenuItem` per :class:`~ovwidgets.common.asset_types.AssetCategory`
...
# :attr:`AssetTypeDef.display_name` strings in :mod:`ovwidgets.common.asset_types`
...
class FilterButton:
    ...
    def build(self) -> None:
        ...
        with self._zstack:
            ...
            # style variants in :mod:`ovwidgets.content.style`
