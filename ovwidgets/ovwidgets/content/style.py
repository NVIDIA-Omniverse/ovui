...
:func:`ovwidgets.app.style.set_theme` re-applies the merged global style.
"""
...
CONTENT_STYLES: dict = {
    ...
    # grid card when a rename is in flight. Matches the ovwidgets.stage
    ...
    # mirrors ``ovwidgets.stage``'s layout: an outer ``Content.SearchField.Bar``
