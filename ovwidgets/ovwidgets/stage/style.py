...
STAGE_STYLES = {
    ...
    #     readable against Victor's corrected #222222 header strip)
    ...
    #
    # Token anchor (locked to ovuiDark rev-9 — OVUI_REFERENCE_IMPLEMENTATION_PLAN
    # Step 3.4 / UI-033, defined in ``ovwidgets/common/style/palette.py``):
    ...
    "TreeView": {
        ...
        # ``ovwidgets/ovwidgets/layers/style.py:33-37``), NOT from
