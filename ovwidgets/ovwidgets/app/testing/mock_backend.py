...
:class:`ovwidgets.app.testing.MockStageAdapter`: a fully self-contained
...
class MockBackend(BackendAdapter):
    ...
    def subscribe_changes(
        ...
        :class:`ovwidgets.common.settings.Subscription` — tests can hold it,
...
class _MockBackendSubscription:
    ...
    Duck-types :class:`ovwidgets.common.settings.Subscription`: public ``cancel``
    ...
    pattern :class:`ovwidgets.common.settings.Subscription` uses for the settings
    store.
    """
