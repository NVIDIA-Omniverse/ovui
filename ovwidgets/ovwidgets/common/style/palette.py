...
Dark values follow Victor's latest reference hierarchy for this pass:
...
# ---------------------------------------------------------------------------
# Backgrounds — follow Victor's latest two-tier correction against
...
# Outermost dockspace void (UI-021). Victor's latest correction makes the broad
# application background match the window/panel chrome at #222222. Wired through
