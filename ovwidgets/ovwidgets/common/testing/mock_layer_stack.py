...
``ovwidgets.common.settings.Subscription`` and the layer-adapter ABC family from
:mod:`ovwidgets.common.adapters`.

Subscription semantics match :class:`ovwidgets.common.selection.SelectionBus` exactly —
a plain subscriber list plus ``_remove_subscriber`` to satisfy the existing
:class:`ovwidgets.common.settings.Subscription` cancel contract.
"""
