...
``ovwidgets.property.builders.scalar`` and ``ovwidgets.property.builders.vec3``.
...
class _BuilderSubscription:
    ...
    ``_UsdPropertySubscription`` from ``ovwidgets.stage/usd_property_adapter.py``
...
class WidgetBuilderTable:
    ...
    ``ovwidgets.property.builders.__init__``). Third-party code may add
