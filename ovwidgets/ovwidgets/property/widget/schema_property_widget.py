...
:class:`~ovwidgets.property.widget.SimplePropertyWidget` that auto-discovers
...
class SchemaPropertyWidget(SimplePropertyWidget):
    ...
    Subclasses typically:
        ...
        * let the base :meth:`build_items_content` emit the rows through
          :class:`~ovwidgets.property.builders.WidgetBuilderTable`.
    ...
    def build_items_content(self) -> None:
        ...
        through :class:`~ovwidgets.property.builders.WidgetBuilderTable` the
