...
of :class:`~ovwidgets.property.widget.PropertyWidget` that parks the pattern
...
via :meth:`ovwidgets.app.application.Application.call_later`, and
...
the wrapper. Step 6.2's :class:`~ovwidgets.property.widget.AttributesWidget`
...
class SimplePropertyWidget(PropertyWidget):
    ...
    def add_item_with_model(
        ...
        existing :class:`~ovwidgets.property.models.attribute_model.AttributeModelBase`
