...
:class:`~ovwidgets.property.window.PropertyWindow` consults on every rebuild
to decide which :class:`~ovwidgets.property.widget.PropertyWidget` sections
...
* :meth:`register_scheme_delegate` accepts
  :class:`~ovwidgets.property.widget.scheme_delegate.PropertySchemeDelegate`
...
* :meth:`get_widgets_for_payload` invokes every factory registered
  ...
  :class:`~ovwidgets.property.widget.AttributesWidget`) stay isolated
...
:class:`~ovwidgets.property.widget.AttributesWidget` under scheme
...
class _WidgetSubscription:
    ...
    ``_HandlerSubscription`` pattern elsewhere in ovwidgets.property —
...
class PropertySchemeRegistry:
    ...
    def instance(cls) -> "PropertySchemeRegistry":
        ...
        :mod:`ovwidgets.property.window` or the test module imported this
        module first.
        """
