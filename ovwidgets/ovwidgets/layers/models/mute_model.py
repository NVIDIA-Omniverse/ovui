...
- :meth:`set_value` pushes a :class:`SetLayerMutenessCommand` through
  the owning :class:`~ovwidgets.app.application.Application`'s
  :class:`~ovwidgets.common.undo.UndoManager` so the mute toggle joins the undo
...
:class:`~ovwidgets.layers.models.save_model.SaveValueModel`, whose boolean
...
from ovwidgets.layers.commands import SetLayerMutenessCommand
