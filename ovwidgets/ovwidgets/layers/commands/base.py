...
contract that every concrete command in :mod:`ovwidgets.layers.commands`
shares:

- Snapshot the edit target + :class:`~ovwidgets.common.selection.SelectionBus`
...
from ovwidgets.common.selection import SelectionBus, SelectionBusError
from ovwidgets.common.undo import Command

LAYERS_COMMAND_SOURCE = "ovwidgets.layers:command"
...
LAYERS_UNDO_SOURCE = "ovwidgets.layers:undo"
...
so :class:`~ovwidgets.layers.window.LayerSelectionWatch` (Step 57) can
...
class AbstractLayerCommand(Command):
    ...
    def _restore_state(self) -> None:
        ...
        **second**. Downstream subscribers to the selection event
        ...
        A :class:`~ovwidgets.common.selection.SelectionBusError` on publish means
