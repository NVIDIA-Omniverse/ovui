...
The model wraps a :class:`~ovwidgets.common.adapters.LayerStackAdapter` (the
...
from ovwidgets.layers.commands.layer_commands import SetEditTargetCommand
...
class LayerModel(ui.AbstractItemModel):
    ...
    def __init__(
        ...
        # :class:`~ovwidgets.layers.layer_delegate.LayerDelegate` consults
    ...
    def drop(
        ...
        fabricating an :class:`~ovwidgets.common.undo.UndoManager`.
        """
        if self._destroyed or self._adapter is None:
            self._clear_drop_visual()
            return
    ...
    def _can_move_layer(
        ...
        :class:`~ovwidgets.common.error_reporter.ErrorReporter` toast. Rejection
    ...
    def _perform_file_sublayer_drop(
        ...
        :class:`~ovwidgets.common.undo.UndoManager`.
        """
        ok, reason = self._can_insert_file_sublayer(
    ...
    def _request_save(self, item: LayerItem) -> None:
        ...
        :class:`~ovwidgets.common.error_reporter.ErrorReporter`, and clears the
        ...
        :class:`~ovwidgets.layers.commands.SaveLayerAsCommand` that writes
    ...
    def _request_save_all(self) -> None:
        ...
        :meth:`~ovwidgets.common.adapters.LayerStackAdapter.save_layer`
    ...
    def _request_save_as(
        ...
        1. Compute a sensible default filename (display name + the
           USD extension preferred by :mod:`ovwidgets.common.file_dialogs`).
        2. Open a modal :func:`~ovwidgets.common.file_dialogs.save_file_dialog`.
        ...
        # ovwidgets.app and ovwidgets.layers packages at module-load time.
    ...
    def _request_remove_sublayer(
        ...
        3. Dirty layers open
           :func:`~ovwidgets.common.dialogs.confirm_dirty_remove_dialog`. The
        ...
        from ovwidgets.common.dialogs import confirm_dirty_remove_dialog
    ...
    def _request_reload(self, item: LayerItem) -> None:
        ...
        :func:`~ovwidgets.common.dialogs.confirm_reload_dialog`; on Reload
        ...
        calls :meth:`~ovwidgets.common.adapters.LayerStackAdapter.reload_layer`
        ...
        from ovwidgets.common.dialogs import confirm_reload_dialog
