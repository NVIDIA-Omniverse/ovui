...
class ContextMenuBuilder:
    ...
    def _register_file_io_entries(self) -> None:
        ...
        - **"Save"** (:data:`GROUP_FILE_IO`) — gated on
          ...
          a :class:`~ovwidgets.layers.commands.SaveLayerCommand` (concrete
        ...
        - **"Save As..."** (:data:`GROUP_FILE_IO`) — gated on
          ...
          :class:`~ovwidgets.layers.commands.SaveLayerAsCommand` writes the
        ...
        - **"Reload"** (:data:`GROUP_FILE_IO`) — gated on
          ...
          :func:`~ovwidgets.common.dialogs.confirm_reload_dialog` when the layer
        ...
        - **"Remove"** (:data:`GROUP_DESTRUCTIVE`) — gated on
          ...
          Step-37 :func:`~ovwidgets.common.dialogs.confirm_dirty_remove_dialog`
          for dirty layers and pushes a
          :class:`~ovwidgets.layers.commands.RemoveSublayerCommand` directly
          for clean ones.
    ...
    def _register_mute_lock_entries(self) -> None:
        ...
        - **"Mute Layer" / "Unmute Layer"** — single entry whose
          ...
          :class:`~ovwidgets.layers.commands.SetLayerMutenessCommand` with
        ...
        - **"Lock Layer" / "Unlock Layer"** — same shape for the
          ...
          :class:`~ovwidgets.layers.commands.SetLayerLockCommand`. The
    ...
    def _register_merge_flatten_entries(self) -> None:
        ...
        - **"Merge Down"** — gated on :func:`is_layer_item` +
          ...
          :func:`~ovwidgets.common.dialogs.confirm_merge_down_dialog` scary
          confirmation, and on confirm pushes a
          :class:`~ovwidgets.layers.commands.MergeDownCommand`. The command
        ...
        - **"Flatten Sublayers"** — gated on :func:`is_layer_item` +
          ...
          :func:`~ovwidgets.common.dialogs.confirm_flatten_dialog` with the
          sublayer count, and on confirm pushes a
          :class:`~ovwidgets.layers.commands.FlattenSublayersCommand`.
        ...
        def _merge_down_click(ctx: MenuContext) -> None:
            ...
            from ovwidgets.common.dialogs import confirm_merge_down_dialog
        ...
        def _flatten_click(ctx: MenuContext) -> None:
            ...
            from ovwidgets.common.dialogs import confirm_flatten_dialog
