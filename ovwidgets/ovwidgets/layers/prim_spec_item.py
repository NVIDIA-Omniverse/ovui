...
:class:`~ovwidgets.common.adapters.PrimSpecDescriptor` delivered by
:meth:`LayerStackAdapter.get_prim_specs`. The item is attached to the
:class:`~ovwidgets.layers.layer_item.LayerItem` that hosts the prim spec so
...
class PrimSpecItem(ui.AbstractItem):
    ...
    def has_cached_children(self) -> bool:
        ...
        Used by :class:`~ovwidgets.layers.layer_model.LayerModel` to decide
