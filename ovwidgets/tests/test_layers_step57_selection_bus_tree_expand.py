...
:class:`~ovwidgets.common.selection.SelectionBus` publishes a new selection
...
from ovwidgets.layers.selection_watch import LAYERS_OWN_SOURCES
...
class TestOwnSources:
    def test_constant_contains_namespaces(self) -> None:
        ...
        ``ovwidgets.layers:paste``) needs an intentional edit here and in
        :mod:`ovwidgets.layers.selection_watch`."""
