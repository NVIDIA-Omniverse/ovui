...
"""Tests for :class:`ovwidgets.layers.layer_delegate.LayerDelegate` (Step 17-22).
...
from ovwidgets.layers import LayerDelegate, LayerModel
...
class TestStep23RowSelectionRectangle:
    ...
    def test_build_branch_expanded_row_renders_chevron_glyph(self) -> None:
        ...
        # ``ovwidgets.stage/widget/stage_delegate.py:91-98``); the previous
...
class TestStep25StyleTokens:
    ...
    def test_palette_has_half_edit_token(self) -> None:
        ...
        import ovwidgets.common.style.palette  # noqa: F401 — side-effect registration
