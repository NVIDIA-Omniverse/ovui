...
from ovwidgets.content.widget import SCALE_MAP, ZoomBar
from ovwidgets.content.widget.zoom_bar import (
...
class TestSurface:
    def test_zoom_bar_reexported_from_widget_package(self):
        from ovwidgets.content.widget import ZoomBar as ZB

        assert ZB is _ZoomBar

    def test_scale_map_reexported_from_widget_package(self):
        from ovwidgets.content.widget import SCALE_MAP as SM
