...
teardown chain:
    ...
    Application.shutdown()
        → icon_caches.clear_all()
            → ovwidgets.common.dialogs._clear_open_dialogs() / file_dialogs / confirm_overwrite_dialog
...
3. Inside a unit-test body, ``import ovwidgets.common.dialogs`` fires for the
...
import ovwidgets.common.dialogs  # noqa: F401
import ovwidgets.common.file_dialogs  # noqa: F401
import ovwidgets.content
import ovwidgets.content.widget.confirm_overwrite_dialog  # noqa: F401
...
def test_application_shutdown_destroys_open_confirm_dialog(headless_app):
    """Pushes a fake dialog into ``ovwidgets.common.dialogs._OPEN_DIALOGS``,
    ...
    import ovwidgets.common.dialogs as dlgs
...
def test_application_shutdown_destroys_open_save_file_dialog(headless_app):
    ...
    :data:`ovwidgets.common.file_dialogs._OPEN_DIALOGS`."""
    import ovwidgets.common.file_dialogs as fd
...
def test_application_shutdown_destroys_open_overwrite_dialog(headless_app):
    ...
    import ovwidgets.content.widget.confirm_overwrite_dialog as cod
