...
* :class:`ovwidgets.property.widget.AttributesWidget` is a concrete
...
def fake_group_widget(monkeypatch):
    ...
    The lazy ``from ovwidgets.property.group_widget import AttributeGroupWidget``
...
class TestAttributesWidgetImportShape:
    ...
    def test_re_export_identity(self):
        ...
        from ovwidgets.property.widget import AttributesWidget as A
        from ovwidgets.property.widget.attributes_widget import AttributesWidget as B
        assert A is B
