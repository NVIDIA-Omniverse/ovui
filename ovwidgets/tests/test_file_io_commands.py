...
- :meth:`SaveLayerCommand.do_impl` calls
  :meth:`~ovwidgets.common.adapters.LayerStackAdapter.save_layer` and
  clears the layer's dirty bit on success.
- :meth:`ReloadLayerCommand.do_impl` calls
  :meth:`~ovwidgets.common.adapters.LayerStackAdapter.reload_layer`.
...
class _CollectingReporter:
    """Stand-in for :class:`~ovwidgets.common.error_reporter.ErrorReporter` that
