...
and via :class:`~ovwidgets.common.undo.UndoManager` so the ``Ctrl+Z`` pipeline
verify-bullet from the plan is pinned end-to-end. The value-model
integration block confirms :class:`~ovwidgets.layers.models.mute_model.LocalMuteValueModel`
and :class:`~ovwidgets.layers.models.lock_model.LockValueModel` actually
