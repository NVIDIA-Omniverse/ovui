...
:meth:`ovwidgets.app.application.Application._on_key_pressed` via the matching
...
class TestSurface:
    ...
    def test_proxy_methods_reuse_step_20_37_surfaces(self):
        ...
        # :class:`ovwidgets.app.application.Application` has been dispatching
...
class TestApplicationForwardsToContentWindow:
    ...
    def test_ctrl_press_then_release_updates_widget_modifier_bits(self):
        ...
        from ovwidgets.content.widget.file_browser_widget import _MOD_CTRL
