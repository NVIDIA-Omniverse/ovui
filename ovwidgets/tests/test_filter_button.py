...
from ovwidgets.content.widget import FilterButton
from ovwidgets.content.widget.filter_button import (
...
class TestSurface:
    def test_filter_button_reexported_from_widget_package(self):
        from ovwidgets.content.widget import FilterButton as FB
