...
from ovwidgets.content.widget import SearchField
from ovwidgets.content.widget.search_field import (
    _DEBOUNCE_SECS,
)
from ovwidgets.content.widget.search_field import (
...
class TestSurface:
    def test_search_field_reexported_from_widget_package(self):
        from ovwidgets.content.widget import SearchField as SF
