...
from ovwidgets.layers import DefaultLayerSettings, LayerItem, LayerModel, LayerWindow
...
def fake_save_file_dialog(monkeypatch: pytest.MonkeyPatch) -> Any:
    ...
    the module-level name in :mod:`ovwidgets.common.file_dialogs` (the function
    the lazy import resolves) rather than a name in :mod:`ovwidgets.layers.window`.
    """
