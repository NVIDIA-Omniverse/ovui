...
"""Tests for ovwidgets.app.layout — Step 11 default docking layout."""
...
class TestSplitIniIncludesContent:
    ...
    def test_dock_tree_splits_viewport_column_y(self):
        ...
        """
        from ovwidgets.app import layout
...
class TestCollectLayoutIncludesContent:
    ...
    def test_collect_layout_panel_map_contains_content(self):
        ...
        from ovwidgets.app.layout import _collect_layout
    ...
    def test_restore_layout_panel_map_contains_content(self):
        ...
        from ovwidgets.app.layout import _restore_layout
...
class TestSplitIniIsDpiAware:
    ...
    panels at logical half-width, which is the bug Victor reported.
    """

    def _build_at_dpi(self, scale: float) -> str:
        from unittest.mock import patch

        from ovwidgets.app import layout as layout_module
