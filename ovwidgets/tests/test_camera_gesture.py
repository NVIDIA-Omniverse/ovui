...
class TestTumbleGestureMath:
    ...
    def test_full_height_drag_pitches_pi(self):
        ...
        # ``-_ELEV_CLAMP``.
        from ovwidgets.viewport.camera_controller import _ELEV_CLAMP
...
class TestZoomScrollGestureMath:
    ...
    def test_min_distance_clamp(self):
        ...
        for _ in range(30):
            _set_wheel(g, 100.0)
            g._on_ended()
        from ovwidgets.viewport.camera_controller import _MIN_DIST
    ...
    def test_max_distance_clamp(self):
        ...
        for _ in range(100):
            _set_wheel(g, -100.0)
            g._on_ended()
        from ovwidgets.viewport.camera_controller import _MAX_DIST
