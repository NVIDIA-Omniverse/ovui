...
class TestImportShape:
    def test_importable_from_widget_subpackage(self):
        from ovwidgets.property.widget import PropertySchemeRegistry as R
        assert R is not None

    def test_importable_from_direct_module(self):
        from ovwidgets.property.widget.scheme_registry import PropertySchemeRegistry as R
        assert R is not None

    def test_re_export_identity(self):
        from ovwidgets.property.widget import PropertySchemeRegistry as A
        from ovwidgets.property.widget.scheme_registry import PropertySchemeRegistry as B
        assert A is B
