...
``ui.style.default``. The accompanying
``tests/qa_layers_step60_theme_screenshot.py`` captures the visual
evidence under a live ovui window.
"""
...
from ovwidgets.layers.models.layer_name_model import (
...
SELECTOR_TOKENS: list[tuple[str, str, str]] = [
    ...
    # ``Stage.TreeChevron`` uses (``ovwidgets.stage/style.py:138-140``), so
