...
from ovwidgets.property.builders.builder_table import _BuilderSubscription
...
class TestPublicExport:
    def test_import_from_package(self):
        from ovwidgets.property.builders import WidgetBuilderTable as A
        from ovwidgets.property.builders.builder_table import WidgetBuilderTable as B
        assert A is B

    def test_all_contains_widget_builder_table(self):
        import ovwidgets.property.builders as m
...
class TestBuiltInRegistrations:
    ...
    def test_token_registered_to_token_builder_step_3_3(self):
        ...
        from ovwidgets.property.builders.token import build_token
    ...
    def test_all_five_vec3_share_the_same_builder(self):
        ...
        from ovwidgets.property.builders.vec import build_vec3
        for type_name in ("float3", "double3", "normal3f", "point3f", "vector3f"):
...
class TestFallback:
    def test_unknown_type_routes_to_fallback(self, builder_table, no_ui):
        from ovwidgets.property.attribute_row import _FallbackAttributeRow
        adapter = _TrackingAdapter()
...
class TestScalarBuilders:
    def test_build_float_creates_float_row(self, no_ui):
        ...
        from ovwidgets.property.builders.scalar import build_float
    ...
    def test_build_int_creates_int_row(self, no_ui):
        ...
        from ovwidgets.property.builders.scalar import build_int
    ...
    def test_build_bool_creates_bool_row(self, no_ui):
        ...
        from ovwidgets.property.builders.scalar import build_bool
    ...
    def test_build_string_creates_string_row(self, no_ui):
        ...
        from ovwidgets.property.builders.scalar import build_string
...
class TestColorBuilderRegistrations:
    ...
    def test_color3f_registered_to_build_color3(self):
        from ovwidgets.property.builders.color import build_color3
    ...
    def test_color4f_registered_to_build_color4(self):
        from ovwidgets.property.builders.color import build_color4
...
class TestMatrixBuilderRegistrations:
    ...
    def test_different_widths_map_to_different_builders(self):
        ...
        ``matrix4d`` attribute."""
        from ovwidgets.property.builders.matrix import (
            build_matrix2d,
            build_matrix3d,
            build_matrix4d,
        )
...
class TestAssetBuilderRegistration:
    ...
    def test_asset_registered_to_build_asset(self):
        from ovwidgets.property.builders.asset import build_asset
...
class TestRelationshipBuilderRegistration:
    ...
    def test_relationship_registered_to_build_relationship(self):
        from ovwidgets.property.builders.relationship import build_relationship
...
class TestArrayBuilderRegistration:
    ...
    def test_array_registered_to_build_array(self):
        from ovwidgets.property.builders.array import build_array
