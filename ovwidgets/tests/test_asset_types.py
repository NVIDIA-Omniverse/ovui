...
"""Tests for :mod:`ovwidgets.common.asset_types`.
...
from ovwidgets.common import asset_types
from ovwidgets.common.asset_types import (
    _CATALOG,
    AssetCategory,
    AssetTypeDef,
    categories,
...
class TestImport:
    ...
    def test_module_has_no_heavy_deps(self):
        ...
        forbidden = {"omni", "ui", "url", "backends", "ovwidgets"}
