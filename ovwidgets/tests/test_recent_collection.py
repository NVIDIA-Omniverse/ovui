...
:class:`ovwidgets.common.recent_files.RecentFileList`, in most-recent-first
order, and subscribes to :class:`ovwidgets.common.settings.Settings` so an
...
from ovwidgets.content.widget.collections import (
    CollectionItem,
    RecentFileItem,
...
class TestRecentFilesCollectionIdentity:
    ...
    def test_icon_key_is_non_empty(self):
        ...
        # :mod:`ovwidgets.common.style.urls`.
