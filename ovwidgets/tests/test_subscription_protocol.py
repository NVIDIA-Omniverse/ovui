...
SUBSCRIPTION_CLASSES = [
    ...
    ("ovwidgets.property.models.attribute_model", "_ValueChangeSubscription"),
    ("ovwidgets.property.builders.builder_table", "_BuilderSubscription"),
    ("ovwidgets.property.parts.control_state", "_HandlerSubscription"),
    ("ovwidgets.property.widget.scheme_registry", "_WidgetSubscription"),
    ("ovwidgets.property.widget.scheme_registry", "_DelegateSubscription"),
    ("ovwidgets.content.widget.column_delegate", "_ColumnDelegateSubscription"),
    ("ovwidgets.content.widget.column_delegate", "_ChangedSubscription"),
    ("ovwidgets.common.testing.mock_property", "_MockPropertySubscription"),
    ("ovwidgets.app.testing.mock_backend", "_MockBackendSubscription"),
]
