...
"""Tests for :class:`ovwidgets.layers.layer_model.LayerModel` (LAYERS-PLAN Step 13).
...
class _DeferringApp:
    """Test stand-in for :class:`ovwidgets.app.application.Application`.
...
class TestStep32MuteLockCascade:
    ...
    def test_descendants_color_role_picks_up_mute_cascade(self) -> None:
        ...
        from ovwidgets.layers.models.layer_name_model import COLOR_ROLE_DISABLED
