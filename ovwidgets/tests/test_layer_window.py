...
class TestImportsAndStructure:
    def test_layer_window_exported_from_package(self):
        ...
        assert ovwidgets.layers.LayerWindow is LayerWindow

    def test_layer_stack_adapter_in_ovgear_adapters(self):
        """LayerStackAdapter lives in ovwidgets.common.adapters as of issue #38."""
        from ovui_data_adapters.common import LayerStackAdapter

        from ovwidgets.common.testing.mock_layer_stack import MockLayerStackAdapter
...
class TestWindowLifecycle:
    def test_title_preserves_dock_key(self):
        # ovwidgets.app/layout.py's imgui.ini keys on "Layers" — changing the
