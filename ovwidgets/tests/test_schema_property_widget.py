...
class TestSchemaPropertyWidgetImportShape:
    def test_importable_from_subpackage(self):
        from ovwidgets.property.widget import SchemaPropertyWidget
    ...
    def test_re_export_identity(self):
        from ovwidgets.property.widget import SchemaPropertyWidget as A
        from ovwidgets.property.widget.schema_property_widget import (
    ...
    def test_is_property_widget_subclass(self):
        from ovwidgets.property.widget import PropertyWidget, SchemaPropertyWidget
