...
The plan adds a module-level :func:`ovwidgets.app.application._should_close`
...
3. Manual interactive validation (NOT a unit test — recorded in PR
   description) — run ``python -m ovwidgets.app cube.usda`` interactively,
...
from ovwidgets.app.application import Application, _should_close
