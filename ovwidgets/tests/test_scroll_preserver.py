...
Architecture: :class:`~ovwidgets.property.widget.scroll_preserver.ScrollPreserver`
is a plain helper owned by :class:`~ovwidgets.property.window.PropertyWindow`.
...
class _FakeCallLater:
    ...
    The real :meth:`ovwidgets.app.application.Application.call_later` fires its
...
class TestPackageStructure:
    def test_module_importable(self) -> None:
        import ovwidgets.property.widget.scroll_preserver as mod  # noqa: F401

    def test_class_exported_from_widget_package(self) -> None:
        from ovwidgets.property.widget import ScrollPreserver as Exported
        from ovwidgets.property.widget.scroll_preserver import ScrollPreserver as Direct
        assert Exported is Direct

    def test_class_in_widget_package_all(self) -> None:
        import ovwidgets.property.widget as pkg
