...
from ovwidgets.content.widget import PathField
from ovwidgets.content.widget.path_field import (
    MODE_BREADCRUMB,
    MODE_EDIT,
)
from ovwidgets.content.widget.path_field import (
...
class TestSurface:
    def test_reexported_from_widget_package(self):
        from ovwidgets.content.widget import PathField as PF
...
class TestAutocompleteDropdownStyling:
    """Bug B structural invariants. The actual visual check is a
    screenshot diff in ``tests/qa_addressbar_bugs_repro.py``; these
    unit tests pin the wiring that makes the visual check meaningful.
    """
