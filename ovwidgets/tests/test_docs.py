...
class TestArchitecture:
    ...
    def test_mentions_ovwidgets_app_package(self, content):
        assert "ovwidgets.app" in content or "Application" in content

    def test_mentions_ovwidgets_stage_package(self, content):
        assert "Stage Browser" in content or "stage" in content.lower()

    def test_mentions_ovwidgets_property_package(self, content):
        assert "Property Inspector" in content or "property" in content.lower()

    def test_mentions_ovwidgets_viewport_package(self, content):
...
class TestReadme:
    ...
    def test_mentions_all_packages(self, content):
        assert "ovwidgets.app" in content
        assert "ovwidgets.content" in content
        assert "ovwidgets.stage" in content
        assert "ovwidgets.property" in content
        assert "ovwidgets.viewport" in content
        assert "ovwidgets.layers" in content
