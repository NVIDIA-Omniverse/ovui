...
Covers :class:`ovwidgets.content.widget.DropIndicator` — the
...
from ovwidgets.content.widget.drop_indicator import (
...
class TestPackageSurface:
    def test_reexported_from_widget_package(self):
        from ovwidgets.content.widget import DropIndicator as DI
        from ovwidgets.content.widget.drop_indicator import (
