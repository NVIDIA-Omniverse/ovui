...
+ :meth:`~ovui_widgets.common.adapters.LayerStackAdapter.transfer_layer_content`
...
:func:`ovui_widgets.common.dialogs.confirm_merge_dialog` /
:func:`ovui_widgets.common.dialogs.confirm_flatten_dialog`) before pushing the
...
class MergeDownCommand(AbstractLayerCommand):
    ...
    :func:`~ovui_widgets.layers.context_menu.has_sibling_below` predicate before
    pushing.
    ...
    calls :meth:`~ovui_widgets.common.adapters.LayerStackAdapter.remove_sublayer`
